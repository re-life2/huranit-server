...
public class Reservation {
    ...
    @Column LocalTime reserveEndTime;

    @Builder
    public Reservation(Center center, String companyName, String departmentName, String name, String email, String companyCall, String userCall, String seat, LocalDate reserveDay, LocalTime reserveStartTime, LocalTime reserveEndTime) {
        this.center = center;
